...
export const Footer = () => {
  return (
    <div className="transition-all dark:bg-lime-500 bg-sky-600 dark:text-gray-800 text-slate-50 w-full">
      <div className=" flex container mx-auto justify-between p-5 flex-col items-center sm:flex-row">
        ...
        <div className="flex items-center mt-3 sm:mt-0">
          ...
          <a href="https://twitter.com/_Shantiniketan" target="_blank">
            <i className="fa-brands fa-twitter text-3xl mr-2"></i>
          </a>
